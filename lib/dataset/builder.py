...
def build_dataloader(args):
    ...
    if args.dataset == 'imagenet':
        ...
        args.data_path = 'data/mini_imagenet' if args.data_path == '' else args.data_path
        args.num_classes = 64
        args.input_shape = (3, 224, 224)
    ...
    if args.dataset == 'imagenet':
        ...
        train_transforms_l, train_transforms_r = transform.build_train_transforms(args.aa, args.color_jitter, args.reprob, args.remode, args.interpolation)
        train_dataset = MiniImageNet(args.data_path, split='train', transform=train_transforms_l)

    print('train dataset: {} (x{}), {}'.format(
    ...
    if args.dataset == 'imagenet':
        ...
        val_transforms_l, val_transforms_r = transform.build_val_transforms(args.interpolation)
        val_dataset = MiniImageNet(args.data_path, split='train_phase_val', transform=val_transforms_l)

    print('val dataset: {} (x{}), {}'.format(
